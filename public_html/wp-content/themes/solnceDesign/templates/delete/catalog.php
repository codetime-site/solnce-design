<?php require_once get_template_directory() . "/templates/catalog/catalog_func.php"; ?>
...
<?php require_once get_template_directory() . "/templates/catalog/catalog_script.php"; ?>